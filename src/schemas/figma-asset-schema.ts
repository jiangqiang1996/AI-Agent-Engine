...
export const FIGMA_BROWSER_MODE_AVAILABLE = false
export const FIGMA_DEFAULT_MODE = 'api' satisfies z.infer<typeof FigmaAssetModeSchema>
...
export const FigmaAssetToolArgsSchema = z.object({
  mode: FigmaAssetModeSchema.default(FIGMA_DEFAULT_MODE).describe('执行模式，默认 api；browser 仍处于实验能力验证阶段'),
