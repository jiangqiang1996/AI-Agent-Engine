...
|--|---------------------|--------------------------|
| 确定性内容 | 页面数、路由、布局结构、导航模式、主题色、交互流程 | HTML 结构片段、CSS 样式片段、组件选型、技术栈、Props 契约、状态机、设计 Token |
...
| 组件 ID | 组件名 | 来源 | 文件 |
|---------|--------|------|------|
| COMP-001 | Button | shadcn/ui | 05-components.md |
| COMP-002 | Card | shadcn/ui | 05-components.md |
| COMP-003 | Form | 自研 | 05-components.md |
...
- `[核心]` **技术栈声明**：前端框架、UI 组件库、CSS 方案、图标库、字体、路由方案
...
- `[核心]` **组件清单**：含 TypeScript interface 签名 + HTML 结构片段 + 来源（库/自研）
...
3. 将文字描述升级为 HTML 结构片段 + CSS 样式片段
4. 将页面元素清单升级为组件选型 + Props 契约
5. 补充技术栈声明（ae:prd 原型不含技术栈）
6. 补充设计 Token（ae:prd 原型不含视觉细节）
