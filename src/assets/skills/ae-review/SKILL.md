...
2. **确定审查范围**：审查范围 = 工作区全部文件 - 排除规则 - `ae/prds/` - `ae/designs/` - `.opencode/` - `ae/solutions/`
...
- `ae/reviews/` 目录下的所有文件
- `ae/handoffs/` 目录下的所有文件
- `ae/logs/` 目录下的所有文件
- `ae/screenshots/` 目录下的所有文件
- `ae/markdown/` 目录下的所有文件
- `ae/documents/` 目录下的所有文件
- `ae/reports/` 目录下的所有文件
...
2. 对话中明确提到"审查需求文档"、"审查设计文档"、"审查 .opencode 配置"、"审查经验沉淀"等语义等价表达
3. 用户提供的范围中显式包含 `ae/prds/`、`ae/designs/`、`.opencode/` 或 `ae/solutions/` 路径
