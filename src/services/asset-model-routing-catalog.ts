...
const COMMAND_SCENARIOS: Record<string, ModelScenario> = {
  ...
  [COMMAND.LSM_SPEC]: MODEL_SCENARIO.DEEP,
  [COMMAND.LSM_DESIGN]: MODEL_SCENARIO.DEEP,
  [COMMAND.LSM_MOCKUP]: MODEL_SCENARIO.VISION,
  [COMMAND.LSM_BUILD]: MODEL_SCENARIO.DEEP,
  [COMMAND.LSM_TEST]: MODEL_SCENARIO.DEEP,
  [COMMAND.LSM_VERIFY]: MODEL_SCENARIO.VISION,
  ...
  [COMMAND.MARKITDOWN]: MODEL_SCENARIO.STANDARD,
