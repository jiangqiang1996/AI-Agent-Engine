...
const COMMAND_SCENARIOS = {
  ...
  [COMMAND.API_TEST]: MODEL_SCENARIO.STANDARD,
  [COMMAND.UNIT_TEST]: MODEL_SCENARIO.DEEP,
  [COMMAND.E2E_TEST]: MODEL_SCENARIO.VISION,
  [COMMAND.FRONTEND_FIX]: MODEL_SCENARIO.VISION,
  [COMMAND.BACKEND_FIX]: MODEL_SCENARIO.DEEP,
  ...
  [COMMAND.SPEC_HTML]: MODEL_SCENARIO.DEEP,
