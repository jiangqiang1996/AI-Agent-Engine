...
const COMMAND_SCENARIOS: Record<string, ModelScenario> = {
  ...
  [COMMAND.G1_INVARIANTS]: MODEL_SCENARIO.DEEP,
  [COMMAND.G2_BUSINESS_SCENARIOS]: MODEL_SCENARIO.DEEP,
  [COMMAND.G3_ARCHITECTURE]: MODEL_SCENARIO.DEEP,
  [COMMAND.G4_DATA_MODEL]: MODEL_SCENARIO.DEEP,
  [COMMAND.G5_GLOBAL_TRACE]: MODEL_SCENARIO.DEEP,
  [COMMAND.A1_CONTRACTS]: MODEL_SCENARIO.DEEP,
  [COMMAND.A2_ASSOC_TRACE]: MODEL_SCENARIO.DEEP,
  [COMMAND.L1_UI_SPEC]: MODEL_SCENARIO.DEEP,
  [COMMAND.L2_MODULE_DESIGN]: MODEL_SCENARIO.DEEP,
  [COMMAND.L3_MODULE_VERIFY]: MODEL_SCENARIO.DEEP,
  [COMMAND.V1_E2E_VERIFY]: MODEL_SCENARIO.DEEP,
  [COMMAND.V2_COMPLETENESS]: MODEL_SCENARIO.DEEP,
}
