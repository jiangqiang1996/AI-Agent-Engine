...
const PHASE_ONE_ENTRIES: AeAssetEntry[] = [
  ...
  },
  {
    ...
    description: '提取业务不变量、划定系统边界、识别模块拆分点',
    argumentHint: '[需求描述|需求文档路径]',
    skillFile: `src/assets/skills/${skillDir(SKILL.G1_INVARIANTS)}/SKILL.md`,
  },
  {
    skillName: SKILL.G2_DATA_MODEL,
    commandName: COMMAND.G2_DATA_MODEL,
    description: '从不变量推导实体、字段、关系、约束和状态机',
    argumentHint: '[不变量文档路径]',
    skillFile: `src/assets/skills/${skillDir(SKILL.G2_DATA_MODEL)}/SKILL.md`,
  },
  {
    skillName: SKILL.G3_GLOBAL_TRACE,
    commandName: COMMAND.G3_GLOBAL_TRACE,
    description: '用测试数据代入数据模型和状态机走通核心业务流程',
    argumentHint: '[数据模型文档路径]',
    skillFile: `src/assets/skills/${skillDir(SKILL.G3_GLOBAL_TRACE)}/SKILL.md`,
  },
  {
    skillName: SKILL.A1_CONTRACTS,
    commandName: COMMAND.A1_CONTRACTS,
    description: '定义模块间数据契约、数据流、共享状态和冲突解决策略',
    argumentHint: '[数据模型路径] [推演路径]',
  ...
  },
  {
    ...
    description: '为指定模块完成内部逻辑设计并产出设计文档和 DDL',
    argumentHint: 'module=<模块名> [契约文档路径]',
  ...
  },
  {
    ...
    description: '验证指定模块的数据推演、DDL 落地和文档可还原性',
    argumentHint: 'module=<模块名> [设计文档路径]',
