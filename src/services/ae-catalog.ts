...
const PHASE_ONE_ENTRIES: AeAssetEntry[] = [
  ...
  },
  {
    ...
    description: '创建、编辑、分析、追加、更新块 Word 文档（.docx），支持格式保留、修订追踪和文本提取；与 ae:markitdown（只读转 Markdown）互补，本技能输出仍为 .docx',
  ...
  },
  {
    ...
    description: '处理 PDF 文档：创建、合并、拆分、提取文本/表格、填写表单、追加页面、局部更新；与 ae:markitdown（只读转 Markdown）互补，本技能输出仍为 PDF 或结构化数据',
  ...
  },
  {
    ...
    description: '创建、编辑、分析、追加、更新 PowerPoint 演示文稿（.pptx），支持模板、布局和设计原则；与 ae:markitdown（只读转 Markdown）互补，本技能输出仍为 .pptx',
  ...
  },
  {
    ...
    description: '创建、编辑、分析、追加行、追加表 Excel 电子表格（.xlsx），支持公式、格式、数据分析和图表；与 ae:markitdown（只读转 Markdown）互补，本技能输出仍为 .xlsx',
