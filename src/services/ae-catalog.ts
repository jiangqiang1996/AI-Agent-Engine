...
const PHASE_ONE_ENTRIES: AeAssetEntry[] = [
  ...
  {
    skillName: SKILL.G1_INVARIANTS,
    commandName: COMMAND.G1_INVARIANTS,
    description: '从目标描述中提取业务不变量、划定系统边界、识别模块拆分点',
    argumentHint: '[目标或场景描述]',
    skillFile: `src/assets/skills/${skillDir(SKILL.G1_INVARIANTS)}/SKILL.md`,
  },
  {
    skillName: SKILL.G2_BUSINESS_SCENARIOS,
    commandName: COMMAND.G2_BUSINESS_SCENARIOS,
    description: '从不变量推导业务场景、角色、操作序列和字段目录',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.G2_BUSINESS_SCENARIOS)}/SKILL.md`,
  },
  {
    skillName: SKILL.G3_ARCHITECTURE,
    commandName: COMMAND.G3_ARCHITECTURE,
    description: '定义系统架构、安全约束和非功能性策略',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.G3_ARCHITECTURE)}/SKILL.md`,
  },
  {
    skillName: SKILL.G4_DATA_MODEL,
    commandName: COMMAND.G4_DATA_MODEL,
    description: '从不变量和业务场景推导实体、字段、关系、约束和状态机（禁止 FK）',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.G4_DATA_MODEL)}/SKILL.md`,
  },
  {
    skillName: SKILL.G5_GLOBAL_TRACE,
    commandName: COMMAND.G5_GLOBAL_TRACE,
    description: '用测试数据代入数据模型和状态机走通核心业务流程',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.G5_GLOBAL_TRACE)}/SKILL.md`,
  },
  {
    skillName: SKILL.A1_CONTRACTS,
    commandName: COMMAND.A1_CONTRACTS,
    description: '定义模块间数据契约、数据流、外部系统集成和冲突解决策略',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.A1_CONTRACTS)}/SKILL.md`,
  },
  {
    skillName: SKILL.A2_ASSOC_TRACE,
    commandName: COMMAND.A2_ASSOC_TRACE,
    description: '用具体数据走通跨模块数据流验证契约自洽',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.A2_ASSOC_TRACE)}/SKILL.md`,
  },
  {
    skillName: SKILL.L1_UI_SPEC,
    commandName: COMMAND.L1_UI_SPEC,
    description: '生成结构化界面文档描述并执行可还原性验证',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.L1_UI_SPEC)}/SKILL.md`,
  },
  {
    skillName: SKILL.L2_MODULE_DESIGN,
    commandName: COMMAND.L2_MODULE_DESIGN,
    description: '为指定模块完成内部逻辑设计并产出设计文档和 DDL（禁止 FK）',
    argumentHint: 'module=<模块名>',
    skillFile: `src/assets/skills/${skillDir(SKILL.L2_MODULE_DESIGN)}/SKILL.md`,
  },
  {
    skillName: SKILL.L3_MODULE_VERIFY,
    commandName: COMMAND.L3_MODULE_VERIFY,
    description: '验证指定模块的数据推演、DDL 落地（逻辑引用一致性）和文档可还原性',
    argumentHint: 'module=<模块名>',
    skillFile: `src/assets/skills/${skillDir(SKILL.L3_MODULE_VERIFY)}/SKILL.md`,
  },
  {
    skillName: SKILL.V1_E2E_VERIFY,
    commandName: COMMAND.V1_E2E_VERIFY,
    description: '端到端走通跨模块全链路验证数据流转和契约闭合',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.V1_E2E_VERIFY)}/SKILL.md`,
  },
  {
    skillName: SKILL.V2_COMPLETENESS,
    commandName: COMMAND.V2_COMPLETENESS,
    description: '逐条不变量追踪从声明到实现的证据链识别断裂和遗漏',
    argumentHint: '',
    skillFile: `src/assets/skills/${skillDir(SKILL.V2_COMPLETENESS)}/SKILL.md`,
  },
]
