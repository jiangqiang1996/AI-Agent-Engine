...
- 各全局方向独立文件（`architecture.md` / `security.md` / `observability.md` / `non-functional.md` / `design-spec.md`（由通用 omp task 子代理（UI/UX 设计 persona，mode=spec）产出） / `constraints.md` / `cross-mapping.md`）位于设计目录根下
