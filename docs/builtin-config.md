...
| `/ae-design`、`/ae-plan`、`/ae-refactor`、`/ae-work`、`/ae-merge-branch`、`/ae-review`、`/ae-web-forge`、`/ae-slides-outline`、`/ae-slides-forge`、`/ae-pptx-from-outline`、`/ae-task-loop`、`/ae-grill` | `deep` |
