...
| 资产 | 场景 |
| --- | --- |
| `/ae-brainstorm`、`/ae-prd`、`/ae-prd-update`、`/ae-agent-creator`、`/ae-work-report`、`/ae-my-code-changes`、`/ae-handoff`、`/ae-sql`、`/ae-swagger-parser`、`/ae-test api`、`/ae-test unit`、`/ae-image`、`/ae-audio`、`/ae-video`、`/ae-project-explore`、`/ae-save-experience`、`/ae-prompt-optimize`、`/ae-skill-creator`、`/ae-docx`、`/ae-pdf`、`/ae-pptx`、`/ae-xlsx`、`/ae-officecli`、`/ae-prototype-preview` | `standard` |
| `/ae-design`、`/ae-design-update`、`/ae-work`、`/ae-merge-branch`、`/ae-review`、`/ae-fix backend`、`/ae-slides-outline`、`/ae-task-loop`、`/ae-grill`、`/ae-ocr` | `deep` |
| `/ae-playwright`、`/ae-test e2e`、`/ae-fix frontend` | `vision` |
| `@repo-research-analyst`、`@web-researcher` | `standard` |
| `@ui-architect`、`@e2e-test-runner`、`@frontend-fix` | `vision` |
| `@logic-weaver`、`@spec-flow-analyzer`、`@ui-design-spec`、`@ui-ux-designer`、`@architecture-designer`、`@api-designer`、`@database-designer`、`@test-cases-designer`、`@security-designer`、`@observability-designer`、`@non-functional-designer`、全部 13 个审查专精代理 | `deep` |
| `@frontend-dev`、`@backend-dev`、`@backend-fix` | 继承 opencode 当前默认模型（未声明 `model` frontmatter） |
