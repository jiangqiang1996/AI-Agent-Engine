...
| `/ae-document-review`、`/ae-plan`、`/ae-refactor`、`/ae-lsm-spec`、`/ae-lsm-design`、`/ae-lsm-build`、`/ae-lsm-test`、`/ae-work`、`/ae-merge-branch`、`/ae-review`、`/ae-lfg`、`/ae-task-loop`、`/ae-plan-po`、`/ae-refactor-po`、`/ae-lsm-spec-po`、`/ae-lsm-design-po`、`/ae-lsm-test-po`、`/ae-work-po`、`/ae-lfg-po`、`/ae-task-loop-po`、`/ae-plan-pa`、`/ae-refactor-pa`、`/ae-lsm-spec-pa`、`/ae-lsm-design-pa`、`/ae-lsm-test-pa`、`/ae-work-pa`、`/ae-lfg-pa`、`/ae-task-loop-pa` | `deep` |
| `/ae-prompt-optimize`、`/ae-prompt-optimize-auto`、`/ae-graph-query`、`/ae-help` | `quick` |
| `/ae-lsm-mockup`、`/ae-lsm-verify`、`/ae-chrome-devtools`、`/ae-test-browser`、`/ae-course-auto-player`、`/ae-frontend-design`、`/ae-frontend-design-po`、`/ae-frontend-design-pa` | `vision` |
