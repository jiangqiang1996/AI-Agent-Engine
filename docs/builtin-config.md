...
| `vision` | 视觉任务（`/ae-agent-browser`、`/ae-test-browser`、`/ae-frontend-design`） | 支持图片输入 |
...
| `/ae-agent-browser`、`/ae-test-browser`、`/ae-frontend-design`、`/ae-frontend-design-po`、`/ae-frontend-design-pa` | `vision` |
